 ...
 */
package bycecilie.jpademo.entities;
...
public class tester {
    ...
    Person p2 = new Person("Blondie", 1951);
    ...
    System.out.println("Lad os se om to-vejs cirker: " + a1.getPerson().getName());
    System.out.println("Hvem har betalt f2? Det har: " + f2.getPerson().getName());
    System.out.println("Hvad her der blevet betalt i alt?");
